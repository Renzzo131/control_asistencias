...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        // Actualizar el estado del estudiante a "activo"
        $stmt = $pdo->prepare("UPDATE students SET status = 'activo' WHERE id = :id");
        ...
        $pdo->rollBack();
        $message = "Hubo un error al activar el estudiante. Intente nuevamente.";
    }
} else {
...
<head>
    ...
    <title>Activar Estudiante</title>
