        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="add_student.php"><i class="bi bi-person-plus"></i> Agregar Alumno</a></li>
    ...
    <div class="container-fluid py-4 px-md-5">
        <div class="row mb-4 action-buttons">
            <div class="col-md-6 mb-3 mb-md-0">
                <a href="record_attendance.php" class="btn btn-primary w-100">
                    <i class="bi bi-check-circle"></i> Registrar Asistencia
                </a>
            </div>
            <div class="col-md-6">
                <a href="generate_report.php" class="btn btn-secondary w-100">
